...
export default function PartnerGridView({ currentData }) {
      ...
      <div className="grid grid-cols-5 w-full gap-x-[3vw] gap-y-[1.5vw]">
        {currentData.map((item) => (
          <div
            ...
            onMouseEnter={() => setHoverId(item.operator_id)}
                ...
                <div className="flex flex-row items-center space-x-[0.5vw] ">
                  ...
                  >
                    <FaPhone
                      size="1vw"
                      color={`${
                        item.operator_id != hoverid ? "white" : "#1f487c"
                      }`}
                    />
                  </div>
