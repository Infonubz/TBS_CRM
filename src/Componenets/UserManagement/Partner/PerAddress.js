              ...
              <div className="col-span-1 relative">
                ...
                >
                  <Select
                    showSearch
                    // value={values.per_city}
                    value={values.per_city || undefined}
                    placement="topRight"
                    listHeight={190}
                    onChange={(value) => {
                      handleChange({ target: { name: 'per_city', value } })
                      handleCityChange2(value, setFieldValue)
                    }}
