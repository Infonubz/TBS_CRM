                ...
                >
                  <div className="flex justify-center pl-[5vw] pt-[1vw]">
                    <img
                      ...
                      alt="Profile"
                      className="w-[5vw] h-[10vh] object-cover cursor-pointer rounded-[0.2vw]"
                      onClick={openModal}
                    />
                  ...
                  <div className="flex-col h-[19vh] flex items-center justify-center gap-y-[0.5vw]">
                    <h1 className="font-bold text-[1vw] mt-[.7vw] pt-[0.7vw] text-[#1f4b7f] ">
                      ...
                      {
                        fullname?.length > 17 ? <Tooltip color="white"
                          overlayInnerStyle={{ color: "#1F4B7F" }} placement="top"
