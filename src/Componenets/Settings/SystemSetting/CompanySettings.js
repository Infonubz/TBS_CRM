...
//       setCompanysetting(data);
//       console.log(data, 'handlesubmitbuttonforcompanysettings')
//     } catch (error) {
...
//                         className=" customize-placeholder placeholder-[#1F487C] placeholder:text-[1vw] border-r-[0.25vw] border-l-[0.03vw] border-t-[0.03vw] px-[0.2vw] border-b-[0.25vw] placeholder-blue 
//                       border-[#1F487C] text-[#1F487C] text-[1vw] h-[2.8vw] w-[20vw] rounded-md outline-none"
//                       />
//                       <ErrorMessage
//                         name="company_name"
//                         component="div"
...
//                         className=" customize-placeholder placeholder:text-[1vw] border-r-[0.25vw] px-[0.2vw] border-l-[0.03vw] border-t-[0.03vw] border-b-[0.25vw] placeholder-blue 
//                     border-[#1F487C] text-[#1F487C] text-[1vw] h-[2.8vw] w-[20vw] rounded-md outline-none"
//                       />
//                       <ErrorMessage
//                         name="financial_year_end"
...
//                         className=" customize-placeholder border-r-[0.25vw] placeholder-[#1F487C] placeholder:text-[1vw] border-l-[0.03vw] border-t-[0.03vw] border-b-[0.25vw] placeholder-blue 
//                       border-[#1F487C] text-[#1F487C] px-[0.2vw] text-[1vw] h-[2.8vw] w-[20vw] rounded-md outline-none"
//                       >
...
//                         className=" customize-placeholder placeholder-[#1F487C] placeholder:text-[1vw] border-r-[0.25vw]  border-l-[0.03vw] border-t-[0.03vw] border-b-[0.25vw] placeholder-blue 
//                     border-[#1F487C] text-[#1F487C] px-[0.3vw] text-[1vw] h-[2.8vw] w-[20vw] rounded-md outline-none"
//                       />
//                       <ErrorMessage
//                         name="tax_name"
//                         component="div"
