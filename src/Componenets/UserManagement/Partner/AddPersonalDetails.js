...
export default function AddPersonalDetails({
  ...
  //   if (dateInput) {
  //     dateInput.className = "bg-red-500"
  //   }
  // }, []);
  ...
  //   if (dateInput) {
  //     dateInput.setAttribute('data-placeholder', 'Submit a date');
  //   }
  // }, []);

  return (
    <div>
      <div className="border-l-[0.1vw] h-[28vw] pl-[2vw] pr-[1.5vw] border-t-[0.1vw] border-b-[0.3vw] border-r-[0.1vw] rounded-[1vw] border-[#1f4b7f] mt-[1.5vw]">
              ...
              <Form onSubmit={handleSubmit}>
                {spinning ? (
                  ...
                  <div className="gap-y-[1.5vw] flex-col  flex">
                    <div className="overflow-y-scroll gap-y-[1.5vw] flex-col pr-[.5vw]  flex h-[18vw] pb-[1vw]">
                            ...
                            className={`${
                              updatedata || addressback
                                ? enable == false
                                  ...
                                  : ""
                                : ""
                            } border-r-[0.3vw] mt-[0.2vw] border-l-[0.1vw] border-t-[0.1vw] border-b-[0.3vw] placeholder-red border-[#1F487C] text-[#1F487C] text-[1vw] h-[3vw] w-[100%] rounded-[0.5vw] outline-none px-[1vw] placeholder:font-sans`}
                          />
                          <ErrorMessage
                            name="alt_phone"
                            component="div"
                      ...
                      <div className="grid grid-cols-2 w-full gap-x-[2vw]">
                        <div className="col-span-1 relative custom-placeholder">
                          <label className="text-[#1F4B7F] text-[1.1vw] ">
                            Date of Birth
                            <span className="text-[1vw] text-red-600 pl-[0.2vw]">
                              *
