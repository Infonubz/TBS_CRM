...
export default function ListView({
  ...
  const columns = [
      ...
      render: (row, rowdta, index) => {
        ...
        return (
          <div className="">
            ...
            <h1 className="pl-[1vw] text-[1vw] text-[#1F487C]">{serialNumber}</h1>
          </div>
        );
      },
    },
    {
      title: <h1 className="text-[1.2vw] font-semibold  flex items-center justify-center ">Offer Title</h1>,
        ...
        return (
          <div className="flex items-center">
            ...
            {row?.offer_name?.length > 15 ? (
              ...
              <h1 className="text-[1vw] text-[#1F487C]">{row?.offer_name?.slice(0, 15)}</h1>
            )}
          </div>
        );
      },
    ...
    {
      title: <h1 className="text-[1.2vw] font-semibold  flex items-center justify-center">Offer Code</h1>,
    ...
    },
    {
      ...
      render: (row) => {
        return (
          <div className="flex items-center justify-center">
            <p className="text-[1vw] text-[#1F487C]">{`${dayjs(row?.created_date).format(
              "DD MMM, YY"
            )}`}</p>
          </div>
        );
    ...
    },
    {
      ...
      render: (row) => {
        return (
          <div>
            <p className="text-[1vw] text-[#1F487C] flex justify-center">{`${dayjs(row?.start_date).format(
              "MMM DD"
    ...
    },
    {
      ...
      render: (row) => {
        return (
          <div>
            <p className="text-[1vw] text-[#1F487c] flex items-center justify-center">{row.usage}</p>
          </div>
        );
      },
    },
