        ...
        <div className="grid grid-cols-2 gap-[1vw] pt-[1vw]">
          <div className=" relative col-span-1 flex-col flex">
            ...
            <Field
              ...
              className="border-r-[0.25vw] mt-[0.5vw] border-l-[0.1vw] border-t-[0.1vw] border-b-[0.25vw]  border-[#1F487C] text-[#1F487C] text-[1vw] h-[3vw] w-full rounded-[0.5vw] outline-none px-[1vw] placeholder:text-[1vw] placeholder:font-sans"
            />
            <ErrorMessage
              name="offer_name"
              component="div"
                ...
                options={[
                  {
                    value: "",
                    label: (
                      <div className="text-[1vw] px-[0.2vw] pb-[0.1vw] text-[#a9a9a9] font-normal">
                        Select Category
                      </div>
                    ),
                    disabled: true,
                  },
                  {
                    value: 8,
                    label: (
                      <div className="text-[1vw] px-[0.2vw] pb-[0.1vw] font-normal">
                        All
                      </div>
                    ),
                    // "All"
          ...
          <div className="relative col-span-1 flex flex-col">
            ...
            >
              <Select
                ...
                disabled={
                  typeid === "PRO101" &&
                  offerdata?.tbs_user_id?.startsWith("tbs-pro_emp")
                    ? true
                    : false
                }
              ...
              <div className="relative col-span-1 flex flex-col">
                ...
                <div className="relative flex ">
                  <Field
                    ...
                    onBlur={handleBlur}
                    className=" border-r-[0.1vw] mt-[0.5vw] border-l-[0.1vw] border-t-[0.1vw] h-[3vw] w-full   text-[#1F487C] text-[1vw] outline-none px-[1vw] border-b-[0.25vw] border-[#1F487C] rounded-[0.5vw] rounded-r-none placeholder:text-[1vw] placeholder:font-sans"
                  />
        ...
        <div className="grid grid-cols-2 gap-[1vw] pt-[1vw]">
          <div className=" relative col-span-1 flex-col flex">
            ...
            <Field
              ...
              rows="4"
              cols="50"
              className="border-r-[0.25vw] mt-[0.5vw] border-l-[0.1vw] border-t-[0.1vw] border-b-[0.25vw]  border-[#1F487C] text-[#1F487C] text-[1vw] w-full h-[7.5vw] rounded-[0.5vw] outline-none px-[1vw] pt-[0.5vw] placeholder:text-[1vw] placeholder:font-sans"
            />
            <ErrorMessage
              name="offer_desc"
              component="div"
          ...
          <div className=" relative col-span-1 flex flex-col">
                  ...
                  >
                    <Dragger
                      ...
                      onChange={(file) => {
                        ...
                        console.log(draggerImage, "truwwwwwwwwwwwwwwwwww");
                        console.log(offerdata?.offer_img,"offer data")
                      }}
                      height={"7.2vw"}
                      beforeUpload={(file) => {
            ...
            {errors.file && <ErrorMessage
                name="file"
                component="div"
                className={"text-red-500 text-[0.8vw] absolute bottom-[-1.2vw] bg-white w-full z-20"}
              />} 
              {fileName && (<p className={errors.file === "File is empty" ? "text-[#1F4B7F] text-[0.8vw] mt-2 absolute bottom-[-1.3vw] bg-white w-full z-30" : "text-[#1F4B7F] text-[0.8vw] mt-2 absolute bottom-[-1.3vw] bg-white w-full z-10"}>
                {fileName}
              </p>)}
              {fileName && !errors.file &&(<p className={"text-[#1F4B7F] text-[0.8vw] mt-2 absolute bottom-[-1.3vw] bg-white w-full z-50"}>
                {fileName}
              </p>)}
