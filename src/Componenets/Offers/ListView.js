...
export default function ListView({
  ...
  const columns = [
    ...
    {
      title: <h1 className="text-[1.2vw] font-semibold">Code</h1>,
      width: "17vw",
      render: (row) => {
        return (
          <div>
    ...
    {
      title: <h1 className="text-[1.2vw] font-semibold">Created Date</h1>,
      sorter: (a, b) =>
    ...
    {
      title: <h1 className="text-[1.2vw] font-semibold">Updated Date</h1>,
      sorter: (a, b) =>
    ...
    {
      title: <h1 className="text-[1.2vw] font-semibold text-center">Status</h1>,
      width: "10vw",
      render: (row) => {
        return (
    ...
    {
      title: (
        <h1 className="text-[1.2vw] font-semibold text-center">Actions</h1>
      ),
      width: "10vw",
      render: (row) => {
