...
export default function Promotion() {
  ...
  console.log(promoImage, "promo img 1")
  return (
    <>
            ...
            <div className="h-[12vh] w-full flex flex-col ">
              ...
              <div className="pb-[0.5vw] flex justify-between h-full items-center">
                <div className="flex items-center gap-x-[1vw]">
                  ...
                  <div className="relative flex items-center w-[13.85vw] -ml-[0.3vw]">
                    <LiaSearchSolid
                    ...
                    {/* <div className=" flex items-center bg-white placeholder-[#9CA3AF] text-[#1F487C] outline-none pl-[1.75vw] w-[13.85vw] h-[5vh] text-[1vw] placeholder:text-[1vw] border-[#1F487C] border-l-[0.1vw] border-t-[0.1vw] rounded-[0.75vw] border-r-[0.25vw] border-b-[0.25vw] ">
                      <input
                        ...
                        placeholder="Search..."
                        onChange={(e) =>
                          handlePromosearch(e.target.value, dispatch, CurrentTab)
                        }
                    ...
                    <input
                      type="text"
                      value={inputValue}
                      className="bg-white placeholder-[#9CA3AF] text-[#1F487C] outline-none pl-[2vw] pr-[2vw] pt-[0.25vw] w-full h-[5vh] text-[1vw] placeholder:text-[1vw] border-[#1F487C] border-l-[0.1vw] border-t-[0.1vw] rounded-[0.75vw] border-r-[0.25vw] border-b-[0.25vw]"
                      placeholder="Search..."
                      onChange={(e) =>{
                        handlePromosearch(e.target.value, dispatch, CurrentTab)
                    ...
                    <div>
                    {inputValue ? 
                    (<MdCancel size="1.3vw" className="absolute right-[0.8vw] text-[#1F487C] top-[50%] transform -translate-y-1/2 cursor-pointer " onClick={() => {
                          handleClear(); 
                ...
                <div
                  className={`flex ${
                    listType === "operator" ? "items-center" : "items-center"
                  }  gap-x-[1vw] h-[2vw]`}
                >
                  ...
                  <ExportButton dataArray={getpromotionlist} />
                  {listType === "employee" ? (
                    ""
                  ) : (
                    <>
                      ...
                      >
                        <div>
                          <div className="text-[#1F4B7F] font-semibold text-center text-[1.28vw]">
                            Import & Download Promotion Template
                          </div>
                          <button
