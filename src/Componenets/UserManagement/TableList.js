...
const TableList = ({
  ...
  sortOrderEmail,
  handleEmailSort,
  sortOrderOperatorName,
  handleOperatorNameSort,
  sortOrderCompanyName,
  handleCompanyNameSort,
}) => {
  ...
  const columns = [
    ...
    },
    {
      title: (
        <div className="flex items-center justify-evenly  font-bold text-[1.1vw]">
          ...
          <button onClick={handleCompanyNameSort} className="">
            {sortOrderCompanyName === "ascend" ? (
              <Tooltip
                placement="top"
                title="Ascending"
    ...
    },
    {
      title: (
        <div className="flex items-center justify-evenly  font-bold text-[1.1vw]">
          ...
          <button onClick={handleOperatorNameSort}>
            {sortOrderOperatorName === "ascend" ? (
              <Tooltip
                placement="top"
                title="Ascending"
                className="cursor-pointer"
    ...
    },
    {
      ...
      key: "email",
      // sorter: (a, b) =>
      //   a.emailid && b.emailid ? a.emailid.localeCompare(b.emailid) : 0,
        ...
        return (
          ...
          <div className="pl-[1vw]">
            {row?.emailid?.length > 20 ? (
              ...
              <div
                className={`text-[1vw] text-[#1f4b7f] ${
                  !row?.emailid ? "text-center font-bold" : ""
                }`}
              >
  ...
  console.log(currentData, "operatorIDoperatorID wefwefewfcew");
  return (
    <>
      {spinning === true ? (
