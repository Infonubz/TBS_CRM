...
export default function Offers() {
  ...
  const handleClear = () => {
    ...
    }else if(offerFilter=="approved"){
      GetOffersData(dispatch,offerFilter)
    }else if(offerFilter=="hold"){
      GetOffersData(dispatch,offerFilter)
    }else if(offerFilter=="rejected"){
      GetOffersData(dispatch,offerFilter)
    }else if(offerFilter=="draft"){
      GetOffersData(dispatch,offerFilter)
    }
  ...
  // console.log(getofferlist.length, "count")
  
// const nameCount = getofferlist.reduce((acc, item) => {
//   acc[item.occupation] = (acc[item.occupation] || 0) + 1;
//   return acc;
// }, {});

  // console.log(nameCount, "count00")
  // console.log(nameCount.Business, "count")
          ...
          <div className="px-[2.5vw] h-[92vh] relative w-full ">
            <div className="h-[12vh]  w-full flex flex-col ">
              ...
              <div className="pb-[0.5vw] flex  items-center justify-between ">
                ...
                <div className="relative flex items-center -ml-[1vw]">
                  <div className=" flex items-center bg-white placeholder-[#9CA3AF] text-[#1F487C] outline-none pl-[1.75vw] w-[13.85vw] h-[5vh] text-[1vw] placeholder:text-[1vw] border-[#1F487C] border-l-[0.1vw] border-t-[0.1vw] rounded-[0.75vw] border-r-[0.25vw] border-b-[0.25vw] ">
                    <input
                      type="text"
                      value={inputValue}
                      className="w-[10vw] outline-none pt-[0.25vw] pl-[0.25vw]"
                      placeholder="Search..."
                  ...
                  >
                    <Select
                      ...
                      options={[
                        {
                          value: 0,
                          label: <div>All Offers</div>,
                          // "All Offers"
                        },
                        { value: 8, label: <div>All</div> },
                        { value: 1, label: <div>Business</div> },
                        { value: 2, label: <div>General Public</div> },
                        { value: 3, label: <div>Handicapped</div> },
                        { value: 4, label: <div>Pilgrim</div> },
                        { value: 5, label: <div>Senior Citizen</div> },
                        { value: 6, label: <div>Student</div> },
                        { value: 7, label: <div>Tourist</div> },
                      ]}
                      // dropdownStyle={{
                      //   overflowY: "auto",
                      //   zIndex: 1000,
                  ...
                  >
                    <div>
                      <div className="text-[#1F4B7F] font-semibold text-center text-[1.3vw]">
                        Import & Download{" "}
                        {offerType === "redeem" ? "Redeem" : "Discount"}{" "}
                        Template
                      </div>
                      <button
            ...
            {(offerType === "discount"
              ...
              : getredeemlist?.length > 10) && filtered_Offers.length > 10 ? (
