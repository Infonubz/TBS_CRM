 ...
 // const user_name = sessionStorage.getItem("user_name");
    ...
    if (CurrentPage === 1) {
      ...
      try {
        if (promolist.usage) {
          ...
          // ------------------------------------------------------------------------------------------------
          console.log(promolist.background_image.name, "dataaa")
          console.log(promo_background.name,"promo img 1 1")
          // setStartImage("helooooooo")
          // dispatch({ type: 'STARTER_IMAGE', payload: promo_background.name });
          
          // dispatch({ type: 'GET_BG_IMAGE', payload: promolist.background_image.name });
          // -------------------------------------------------------------------------------------------------
          if (data?.message) {
            toast.success(data?.message);
        ...
        console.log(promo_background.name,"dataaa 1")
      } catch (error) {
        console.error("Error uploading data", error);
      }
      //  finally {
  ...
  const fetchGetPromo = async () => {
    try {
      ...
      console.log(data,"list bg")
      console.log(promolist, "list")
      // --------------------------------------------------
      // setStartImage(data.background_image)
      // --------------------------------------------------
...
console.log(promolist, "dataaaaa promolist")
// --------------------------------------------------
// setStartImage("hellooooooo")
// --------------------------------------------------
  return (
    <>
      <Formik
