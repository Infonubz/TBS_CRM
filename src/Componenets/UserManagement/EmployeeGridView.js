...
export default function EmployeeGridView({ currentData }) {
          ...
          currentData?.map((item) => (
            <div
              className={`${
                hoverid == item.tbs_pro_emp_id
                  ...
                  : "bg-white"
              }  h-[15vw] border-[#1f4b7f] border-l-[0.1vw] cursor-pointer border-r-[0.3vw] border-b-[0.3vw] border-t-[0.1vw] rounded-[0.5vw]`}
              onMouseEnter={() => setHoverId(item.tbs_pro_emp_id)}
            ...
            >
              <div className="flex-col flex items-center justify-center h-full w-full gap-y-[0.4vw]">
                ...
                />
                <h1 className="font-bold text-[1vw]">{`${item.emp_first_name} ${item.emp_last_name}`}</h1>
                  ...
                  <div className="flex flex-row items-center space-x-[0.5vw] ">
                    ...
                    >
                      <FaPhone
                        size="1vw"
                        color={`${
                          item.tbs_pro_emp_id != hoverid ? "white" : "#1f487c"
                        }`}
                      />
                    </div>
