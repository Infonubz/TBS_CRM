...
const stationUrl = process.env.REACT_APP_API_WEB_URL
  ...
  const handleCityChange = (value, setFieldValue) => {
    ...
    if (selectedCityData) {
      ...
      setFieldValue('temp_state', selectedCityData.state);
    }
  };
        ...
        {({ handleSubmit, handleChange, values, setFieldValue }) => {
          ...
          return (
            <Form onSubmit={handleSubmit}>
              <div className="overflow-y-auto h-[15.6vw] pb-[1vw]">
              <div className="grid grid-cols-2 w-full gap-x-[2vw] pt-[1vw] pr-[.5vw]">
                     ...
                     <ConfigProvider
                      ...
                      >
                        <Select
                          showSearch
                          // value={values.temp_city}
                          value={values.temp_city || undefined}
                          placement="topRight"
                          listHeight={190}
                          onChange={(value) => {
