...
import {
  ...
  SubmitUserAgreement,
} from "../../../Api/Settings/SystemSettings/LegalInformations";
...
const AboutUs = () => {
  ...
  const [abtIsEdit, setAbtIsEdit] = useState(false);
  const [pvcIsEdit, setPvcIsEdit] = useState(false);
  const [tmcIsEdit, setTmcIsEdit] = useState(false);
  const [useIsEdit, setUseIsEdit] = useState(false);
  ...
  const handleFileChange = (event, key) => {
    ...
    console.log(file, "selected_filess");
  ...
  const getFileName = (key) => {
    switch (key) {
      ...
      case "privacy_policy":
        return legal_info.privacy_policy
          ? "Privacy Policy.txt"
          : "Upload Privacy Policy.txt";
      case "terms_conditions":
        return legal_info.terms_conditions
          ? "Terms and Conditions.txt"
          : "Upload Terms and Conditions.txt";
      case "user_agreement":
        return legal_info.user_agreement
          ? "User Agreement.txt"
          : "Upload User Agreement.txt";
      default:
        return "Upload file";
    }
  };
  ...
  console.log(
    fileContents?.about_us?.trim(),
    fileContents?.privacy_policy?.trim(),
    fileContents?.terms_condition?.trim(),
    fileContents?.user_agreement?.trim(),
    "all_of_the_file_content"
  );
  ...
  const handleDownload = (key) => {
    ...
    switch (key) {
      case "about_us":
        content = fileContents?.about_us
          ? fileContents?.about_us
          : legal_info?.about_us;
        break;
      case "privacy_policy":
        content = fileContents?.privacy_policy
          ? fileContents?.privacy_policy
          : legal_info?.privacy_policy;
        break;
      case "terms_conditions":
        content = fileContents?.terms_condition
          ? fileContents?.terms_condition
          : legal_info?.terms_conditions;
        break;
      case "user_agreement":
        content = fileContents?.user_agreement
          ? fileContents?.user_agreement
          : legal_info?.user_agreement;
        break;
      default:
              ...
              <div>
                <div className="relative mb-2">
                  <input
                    ...
                    onChange={(event) => {
                      handleFileChange(event, "about_us");
                      console.log( event, "filesfiles");
                    }}
                  />
                  <button
                    type="button"
                    className={` border-r-[0.25vw] relative flex items-center justify-between px-[1vw] mt-[0.2vw] border-l-[0.1vw] border-t-[0.1vw] border-b-[0.25vw] placeholder-blue  text-[#1F487C] text-[1vw] h-[3vw] w-[100%] rounded-[0.5vw] outline-none ${
                      abtIsEdit === false
                        ? "cursor-not-allowed border-[#1f477c89]"
                        : "border-[#1F487C]"
                    }`}
                    disabled={abtIsEdit === false}
                    onClick={(event) => {
                  ...
                  >
                    {aboutUs ? (
                      <div
                        className={`cursor-pointer underline-offset-1 underline text-[#1F4B7F] text-[1vw] ${
                          abtIsEdit === false
                            ? "text-[#1f477c89]"
                            : "text-[#1F487C]"
                        }`}
                    ...
                    <FaCloudUploadAlt
                      color={abtIsEdit === false ? "#1f477c89" : "#1F487C"}
                      size={"2vw"}
            ...
            <div className="col-span-5">
              <div className="grid grid-cols-11 gap-[3vw]">
                <button
                  ...
                  }  border-r-[0.25vw] relative  px-[1vw] mt-[0.2vw] border-l-[0.1vw] border-t-[0.1vw] border-b-[0.25vw] placeholder-blue border-[#1F487C]  text-[1vw] h-[3vw] w-[100%] rounded-[0.5vw] outline-none`}
                >
                  <div className="flex justify-center items-center gap-[0.5vw]">
                    <span className="mt-[0.1vw]">
                      <FaEye />
                    </span>
                    <div> Preview</div>
                  </div>
                ...
                {abtIsEdit === false ? (
                  <button
                    type="button"
                    className={`col-span-3 bg-[#1F487C] text-white  border-r-[0.25vw] relative  px-[1vw] mt-[0.2vw] border-l-[0.1vw] border-t-[0.1vw] border-b-[0.25vw] placeholder-blue border-[#1F487C]  text-[1vw] h-[3vw] w-[100%] rounded-[0.5vw] outline-none`}
                    onClick={() => setAbtIsEdit(true)}
                    onMouseEnter={() => {
                      setButtonHover("abt_sve");
                    }}
                    onMouseLeave={() => {
                      setButtonHover("");
                    }}
              ...
              <div>
                <div className="relative mb-2">
                  <input
                    ...
                    onChange={(event) =>
                      handleFileChange(event, "privacy_policy")
                    }
                  />
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <FaCloudUploadAlt
                      color={pvcIsEdit === false ? "#1f477c89" : "#1F487C"}
                      size={"2vw"}
                      className="absolute right-[1vw]"
                    />
                  </button>
            ...
            <div className="col-span-5">
              <div className="grid grid-cols-11 gap-[3vw]">
                ...
                {pvcIsEdit === false ? (
                  ...
                  <button
                    type="button"
                    className={`col-span-3  bg-[#1F487C] text-white border-white border-r-[0.25vw] relative  px-[1vw] mt-[0.2vw] border-l-[0.1vw] border-t-[0.1vw] border-b-[0.25vw] placeholder-blue  text-[1vw] h-[3vw] w-[100%] rounded-[0.5vw] outline-none`}
                    onClick={() => handleSave(privacyPolicy, "privacy_policy")}
                    onMouseEnter={() => {
                      setButtonHover("pyc_sve");
                    }}
                    onMouseLeave={() => {
                      setButtonHover("");
                    }}
              ...
              <div>
                <div className="relative mb-2">
                  <input
                    ...
                    onChange={(event) =>
                      handleFileChange(event, "terms_condition")
                    }
                  />
                  <button
                    type="button"
                    className={` border-r-[0.25vw] relative flex items-center justify-between px-[1vw] mt-[0.2vw] border-l-[0.1vw] border-t-[0.1vw] border-b-[0.25vw] placeholder-blue border-[#1F487C] text-[#1F487C] text-[1vw] h-[3vw] w-[100%] rounded-[0.5vw] outline-none ${
                      tmcIsEdit === false
                        ? "cursor-not-allowed border-[#1f477c89]"
                        : "border-[#1F487C]"
                    }`}
                    disabled={tmcIsEdit === false}
                    onClick={(event) => {
                      event.preventDefault();
                  ...
                  >
                    ...
                    <FaCloudUploadAlt
                      color={tmcIsEdit === false ? "#1f477c89" : "#1F487C"}
                      size={"2vw"}
                      className="absolute right-[1vw]"
                    />
                  </button>
              ...
              <div className="grid grid-cols-11 gap-[3vw]">
                ...
                {tmcIsEdit === false ? (
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleSave(termsConditions, "terms_condition")
                    }
                    onMouseEnter={() => {
                      setButtonHover("tmc_sve");
                    }}
                    onMouseLeave={() => {
                      setButtonHover("");
                    }}
              ...
              <div>
                <div className="relative mb-2">
                  <input
                    ...
                    accept=".txt"
                    onChange={(event) => {
                      handleFileChange(event, "user_agreement");
                    }}
                  ...
                  >
                    ...
                    <FaCloudUploadAlt
                      color={useIsEdit === false ? "#1f477c89" : "#1F487C"}
                      size={"2vw"}
                      className="absolute right-[1vw]"
                    />
                  </button>
          ...
          >
            ...
            >
              <div className=" flex justify-between px-[3vw] pt-[1vw] pb-[0.5vw]">
                <p className="order-first  text-[#1F487C] text-[1.54vw] font-bold">
                  {modalTitle} :
                </p>
                <button
                  onClick={closeModal}
                  className="order-last text-gray-500 text-lg float-right hover:bg-blue-100 hover:rounded-lg"
                >
