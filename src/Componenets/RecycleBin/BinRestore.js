...
const BinRestore = ({SetRestoreModalOpen,url,title,getId}) =>{

    const dispatch = useDispatch()
const handlesubmit = async() =>{
   const response = await RestoreBinData(dispatch,url,getId)
   toast.success(response,getId)
    SetRestoreModalOpen(false)
}

console.log(url,getId,"urlurlurlurl");
